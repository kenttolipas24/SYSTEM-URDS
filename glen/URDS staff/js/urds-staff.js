...
function loadComponents() {
    ...
    fetch('components/dashboard-content.html')
        .then(res => res.text())
        .then(data => {
...
function loadProposalIntake() {
    fetch('components/proposal-intake.html')
        .then(res => res.text())
        .then(html => {
...
function loadInHouseSchedule() {
    fetch('components/in-house-schedule.html')
        .then(res => res.text())
        .then(html => {
            document.getElementById('dashboard-content-placeholder').innerHTML = html;
...
function loadEvaluatorPool() {
    fetch('components/evaluator-pool.html')
        .then(res => res.text())
        .then(html => {
            document.getElementById('dashboard-content-placeholder').innerHTML = html;
